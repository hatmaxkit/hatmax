...
func (h *GrantHandler) CreateGrant(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json"); w.WriteHeader(http.StatusCreated); json.NewEncoder(w).Encode(core.SuccessResponse{Data: grant})
}
...
func (h *GrantHandler) GetGrant(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "application/json"); w.WriteHeader(http.StatusOK); json.NewEncoder(w).Encode(core.SuccessResponse{Data: grant})
}
